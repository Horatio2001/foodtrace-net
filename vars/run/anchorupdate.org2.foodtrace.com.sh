...
jq '.channel_group.groups.Application.groups."org2-foodtrace-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "101.43.206.180","port": 7007}]},"version": "0"}}' mychannel_current_config.json > mychannel_modified_anchor_config.json
